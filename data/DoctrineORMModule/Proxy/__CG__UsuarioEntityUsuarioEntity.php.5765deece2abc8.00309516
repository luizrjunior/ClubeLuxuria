...
class UsuarioEntity extends \Usuario\Entity\UsuarioEntity implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Usuario\\Entity\\UsuarioEntity' . "\0" . 'idUsuario', '' . "\0" . 'Usuario\\Entity\\UsuarioEntity' . "\0" . 'stUsuario', '' . "\0" . 'Usuario\\Entity\\UsuarioEntity' . "\0" . 'tpUsuario', '' . "\0" . 'Usuario\\Entity\\UsuarioEntity' . "\0" . 'noUsuario', '' . "\0" . 'Usuario\\Entity\\UsuarioEntity' . "\0" . 'login', '' . "\0" . 'Usuario\\Entity\\UsuarioEntity' . "\0" . 'senha', '' . "\0" . 'Usuario\\Entity\\UsuarioEntity' . "\0" . 'email', '' . "\0" . 'Usuario\\Entity\\UsuarioEntity' . "\0" . 'sgUf', '' . "\0" . 'Usuario\\Entity\\UsuarioEntity' . "\0" . 'dtCadastro');
        }
